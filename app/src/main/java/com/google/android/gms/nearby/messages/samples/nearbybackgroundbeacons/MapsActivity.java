...
//        });
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        ...
        String parameters = str_origin + "&" + str_dest + "&" + sensor + "&units=metric&mode=transit";
    ...
    public void onLocationChanged(Location location) {
        ...
        markerOptionsD.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
